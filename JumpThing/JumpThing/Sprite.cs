...
namespace JumpThing
{
    class Sprite
    {
        ...
        public Vector2 spritePos, spriteVel,               // location of the sprite on-screen, velocity of the sprite in pixels per second
        ...
        public List<List<Rectangle>> anims;                // a 2D table of animation frames, each stored as a rectangle to be selected from a sprite sheet
        ...
        public Sprite(Texture2D newSpritesheet, Texture2D newCollisionTex, Vector2 newPos)
        {
            ...
            anims[0].Add(new Rectangle(5, 5, 246, 315));
        }
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gametime)
        {
            ...
            if (anims[currentAnim].Count > 1) // only advance animation if the current animation has multiple frames
            {
                ...
                if (currentFrame >= anims[currentAnim].Count) currentFrame = 0; // if we have reached the end of the animation, start again from frame 0
            }
            ...
            spriteBatch.Draw(
                ...
                anims[currentAnim][currentFrame],  // the SOURCE rectangle is the current frame of the current animation
        ...
        public int getWidthForDraw()
        {
            ...
            return (int)(anims[currentAnim][currentFrame].Width * spriteScale.X);
        }
        ...
        public int getHeightForDraw()
        {
            ...
            return (int)(anims[currentAnim][currentFrame].Height * spriteScale.Y);
        }
